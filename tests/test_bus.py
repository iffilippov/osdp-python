...
class BusTestCase(unittest.TestCase):
    ...
    def test_id_report_checksum(self):
        ...
        connection.should_reply = bytes.fromhex(
            "53 FF 13 00 03 45 A4 D9 A4 03 FF 33 00 01 70 03 00 02 87"
        )
        ...
        self.assertEqual(
            reply.extract_reply_data.hex().upper(), "A4D9A403FF33000170030002"
        )
    ...
    def test_poll_card_data_checksum(self):
        ...
        connection.should_reply = bytes.fromhex(
            "53 FF 0F 00 02 50 FF 01 1A 00 CD 22 C7 16 67"
        )
    ...
    def test_poll_keypad_data_checksum(self):
        ...
        connection.should_reply = bytes.fromhex(
            "53 FF 0D 00 02 53 FF 04 31 32 33 34 7F"
        )
